...
c(
  `Simona Stančíková` = "Zadanie5", `Kristína Ivánová` = "Zadanie5",
  `Jan Hrtanek` = "Zadanie3", `Ivana Oravcova` = "Zadanie6", `Adam Barčák` = "Zadanie5",
  `Yelyzaveta Horbachova` = "Zadanie4", `Zuzana Tomcikova` = "Zadanie3",
  `Lukas Macko` = "Zadanie1", `Matej Farský` = "Zadanie6", `Martin Maslan` = "Zadanie7",
  `Filip Blaho` = "Zadanie2", `Lucia Bakošová` = "Zadanie1",
  `Daria Zaika` = "Zadanie7", `Anna Budinská` = "Zadanie2", `Sebastian Fister` = "Zadanie3",
  `Lucia Tóthová` = "Zadanie3", `Andrej Halama` = "Zadanie7"
)
```
