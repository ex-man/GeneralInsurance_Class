...
plot(Paid_HH_Large_triangle) #v roku 2008 (2) nam vyslo o 2 roky (a o viac rokov) viac Sumofamount ako vyslo v roku 2007 (1) o 3 roky (a viac rokov). Najvacsie zmeny v Sumofamount nastavaju o rok a o 2 roky pre vsetky origin (tie su 2007-2016), potom sa Sumofamount zacina ustalovat. Najviac ma Sumofamount pre rok pre 2011 (5) a najmenej pre rok 2014 (8)   
