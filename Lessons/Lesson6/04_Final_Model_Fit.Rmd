...
- Car Type:
  ...
  - Motorbike : 0.49 multiplier to the base price
  - Pickup: 0.94 multipler to the base price
  - Truck: 1.64 multiplier to the base price
- Car Construction Year:
  ...
  - The multiplier for a new value, e.g. year 2014 will be 1.115 computed as follows:
    - exp(beta * value_new) / exp(beta * value_ref)
    - exp(0.02726*2014) / exp(0.02726*2010)
