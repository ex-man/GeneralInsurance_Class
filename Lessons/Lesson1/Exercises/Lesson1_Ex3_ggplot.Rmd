...
> We used `ggplot` function specifying *data* set to use, `aes` function to specify *aestetics* (visualisation) and *geoms* function `geom_point` to specify how data should be represented.  
...
> Visit https://rstudio.github.io/cheatsheets/data-visualization.pdf for more information about ggplot2