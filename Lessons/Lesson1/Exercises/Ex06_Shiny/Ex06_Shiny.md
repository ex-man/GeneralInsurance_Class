...
> At the start of every `shiny` app we will have to load `shiny` library to be able to run any app. 
> Afterwards, the server part is defined. It must be a function with input and output parameters.  
